...
export const ROBACHA_SPONSOR_REGISTRY_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct RobachaSponsorRegistry.Campaign",
        "components": [
          {
            "name": "campaignId",
            "type": "uint256",
  ...
  {
    "type": "event",
    "name": "CampaignDistributionRecorded",
    "inputs": [
      {
        "name": "campaignId",
        "type": "uint256",
