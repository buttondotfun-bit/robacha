  ...
  return (
    <div className={className}>
          ...
          {SPIN_SHORTCUTS.filter((shortcut) => shortcut <= ceiling).map((shortcut) => (
            <button
              ...
              className={cn(
                ...
                value === shortcut
                  ? "bg-white/85 text-ink shadow-[0_1px_0_rgba(255,255,255,0.9)_inset,0_2px_6px_-2px_rgba(16,17,15,0.12)]"
      ...
      <input
        ...
        className="mt-3 h-1.5 w-full cursor-pointer appearance-none rounded-full bg-[rgba(20,24,18,0.08)] accent-[#ccff00] disabled:opacity-40 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-[#bfe800] [&::-webkit-slider-thumb]:bg-accent"
      />
