...
export function NftTeaser() {
  ...
  return (
    <>
      ...
      {/* One line and a link, not a second pitch. The teaser page carries the
          idea; duplicating it here would be two places to keep honest. */}
        ...
        <Reveal className="glass-card relative flex flex-wrap items-center justify-between gap-4 overflow-hidden rounded-[24px] p-5 sm:p-6">
          <div className="flex items-center gap-4">
            <span aria-hidden="true" data-rarity="grail">
              <CapsuleGlyph id="teaser-spins" className="capsule-float h-11 w-11" />
            </span>
            <div>
